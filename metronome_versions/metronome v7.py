...
label1 = tk.Label(frame, text="Recording voice")
label1.config(font=('helvetica', 14))
frame.create_window(200, 25, frame=label1)

label2 = tk.Label(frame, text="Enter your BPM:")
label2.config(font=('helvetica', 10))
frame.create_window(200, 100, frame=label2)

entry1 = tk.Entry(root) 
frame.create_window(200, 140, frame=entry1)

label3 = tk.Label(root, text="BPM entered is an integer value between 40 and 300.")
label3.config(font=('helvetica', 8))
frame.create_window(200, 100, frame=label3)

label4 = tk.Label(root, text=":)")
label4.config(font=('helvetica', 8))
frame.create_window(200, 210, frame=label4)



dot = frame.create_oval(0, 0, 40, 40, outline='')
...
frame.create_window(200, 180, frame=button1)
